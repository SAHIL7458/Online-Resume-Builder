...
// Form elements and their corresponding types
...
// Display elements for previewing entered data    
...
// Function to fetch values from various form elements    
...
// Function to get user inputs from the form
const getUserInputs = () => {
...
// Event listeners for form elements to trigger validation
...
// Function to display error message for invalid form data
function addErrMsg(formElem, formElemName) {
    formElem.nextElementSibling.innerHTML = `${formElemName} is invalid`;
}

// Function to remove error message for valid form data
function removeErrMsg(formElem) {
    formElem.nextElementSibling.innerHTML = "";
}

// Function to display entered data in the preview section
...
// Function to display user data in the CV preview section
...
// Function to generate CV based on user inputs
const generateCV = () => {
